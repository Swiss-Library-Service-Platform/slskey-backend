...
return new class () extends Migration {
    ...
    public function up()
    {
        Schema::table('slskey_groups', function (Blueprint $table) {
            ...
            $table->integer('webhook_token_reactivation_days_send_before_expiry')->nullable()->after('webhook_mail_activation_domains');
            $table->integer('webhook_token_reactivation_days_token_validity')->nullable()->after('webhook_token_reactivation_days_send_before_expiry');
        });
