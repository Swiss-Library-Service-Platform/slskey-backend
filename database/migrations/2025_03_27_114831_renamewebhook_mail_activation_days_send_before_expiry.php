...
return new class () extends Migration {
    ...
    public function up(): void
    {
        Schema::table('slskey_groups', function (Blueprint $table) {
            $table->renameColumn('webhook_mail_activation_days_send_before_expiry', 'mail_token_reactivation_days_send_before_expiry');
        });
        Schema::table('slskey_groups', function (Blueprint $table) {
            $table->renameColumn('webhook_mail_activation_days_token_validity', 'mail_token_reactivation_days_token_validity');
        });
    }
