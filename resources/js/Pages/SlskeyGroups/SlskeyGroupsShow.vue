    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                mail_token_reactivation: this.slskeyGroup.data.mail_token_reactivation,
                ...
                mail_token_reactivation_days_send_before_expiry: this.slskeyGroup.data.mail_token_reactivation_days_send_before_expiry,
                mail_token_reactivation_days_token_validity: this.slskeyGroup.data.mail_token_reactivation_days_token_validity,
