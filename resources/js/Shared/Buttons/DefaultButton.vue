...
<template>
    ...
    // Internal static classes
        'inline-flex items-center cursor-pointer shadow text-slsp bg-slsp-bg border-slsp border h-fit px-4 py-2 rounded-sm justify-center font-bold text-md focus:outline-none focus:ring focus:ring-slsp-bg active:bg-opacity-70 disabled:opacity-25',
