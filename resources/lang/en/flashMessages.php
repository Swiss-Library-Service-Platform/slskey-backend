...
return [
    ...
    'errors' => [
        ...
        'switch_user_not_found' => 'No User found in SWITCH edu-ID.',

        'token_activation_mail_revoked' => 'The e-mail address that gave you access to SLSKey has been removed from your Switch edu-ID account. Please re-add the e-mail address to your edu-ID to get access to SLSKey.',
